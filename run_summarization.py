...
# Where to find data
tf.app.flags.DEFINE_string('data_path', 'finished_files/test.bin', 'Path expression to tf.Example datafiles. Can include wildcards to access multiple datafiles.')
